...
from sentimentAnalysis.MachineLearning.MLSentimentManager import MachineLearningSentimentAnalyzer
...
def read_english_corpus():
    ...
    _train_negative_docs = pre.CorpusFromFile('../datasets/twitter/train-neg.txt')
    _train_negative_docs = _train_negative_docs.docs[:5000]
    _train_positive_docs = pre.CorpusFromFile('../datasets/twitter/train-pos.txt')
    _train_positive_docs = _train_positive_docs.docs[:5000]
    _test_negative_docs = pre.CorpusFromFile('../datasets/twitter/test-neg.txt')
    _test_negative_docs = _test_negative_docs.docs[:5000]
    _test_positive_docs = pre.CorpusFromFile('../datasets/twitter/test-pos.txt')
...
def read_korean_corpus():
    ...
    corpus = pre.CorpusFromFieldDelimitedFileForClassification('../datasets/ratings.txt', doc_index=1, class_index=2)
