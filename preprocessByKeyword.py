...
# Filter news articles by keyword (case insensitive) from MongoDB
def filter_by_keyword(keyword):
    connect("news_scraping", host="localhost", port=27017)

    articles = Article.objects(content__icontains=keyword)

    filePath = "./data/keyword_" + keyword + "_data.txt"
...
# Pre-process news articles by keyword (case insensitive)
def process_by_keyword(keyword):
    ...
    filePath1 = "./data/keyword_" + keyword + "_data.txt"
    ...
    filePath2 = "./result/keyword_" + keyword + "_result.txt"
